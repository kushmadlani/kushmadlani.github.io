<!-- Definitely worth having a blog post about this, possibly taking a look at a kaggle dataset and working through it (and you can add the project to your repo). show some basic plots, sense check the figures, then more on to more interesting questions / analysis  -->
